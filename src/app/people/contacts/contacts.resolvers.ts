...
import { Contact, Country, Tag } from '../contacts/contacts.types';
...
export class ContactsResolver implements Resolve<any>
{
     ...
     * Constructor
     */
    constructor(private _contactsService: ContactsService, private _loadingScreen: FuseSplashScreenService)
    {
    }
